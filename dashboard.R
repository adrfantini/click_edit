...
#click_edit
version="4.3.2"
versiontime="10 Oct 2016"

#### READ ALL OPTIONS CAREFULLY! ####

{##TODO and CHANGELOG
##CHANGELOG
#4.3.1 -> 4.3.2 (10 oct 2016)
#Added a check for pkg rgdal
#Added 5 TODOs (yay...)
...
##TODO
#see https://blog.snap.uaf.edu/2014/01/07/r-shiny-plot3d-rgl-images-only/
#reading and then saving the file giorgio sent me on 17/05/07 makes a mess (due to the remap, I guess)
#Option to plot without a background and without remapping, but with the map borders behind
#Make "step" in the range function a modifiable option, now it is hardcoded step=1
#https://rstudio.github.io/leaflet/morefeatures.html
#https://rstudio.github.io/leaflet/projections.html
#Use distance and shape measuring capabilities of leaflet, should be all right now
#Use mapview option without projection, if no projection is passed
#Hover should also be fixed somehow, check some github conversation...
#Use the pacman package for package management
#mapview() has a nice cubeview thingy, for layers, check it out
#Also see this https://github.com/rstudio/leaflet/issues/195#issuecomment-251531131 to highlight polygons
...
##willfix
#Add leaflet.draw: https://github.com/Leaflet/Leaflet.draw
#                  https://github.com/byzheng/leaflet/blob/5c207af4764dc83e1736e1e4dd8e88e9fca84856/R/plugin-draw.R
#                  https://github.com/rstudio/leaflet/issues/227
#Add addMeasure() !!! http://environmentalinformatics-marburg.github.io/web-presentations/20150723_mapView.html#mapview-leaflet (this is now included in leaflet)
#Add an option to add more color palettes.
#Undo button
#In multiple selection, if you reclick on a point, it should be deselected, and tooltips should be on hover only
...
{## OPTIONS (READ ME!)
  ...
  inputFile    = "outfile.nc" #Input file name
...
check_package("rgdal")#Needed for raster
